...
public class CalculadoraDescontoCompletoIdosoComMaisDeCincoDependentes implements CalculadoraDesconto {

    private static final Double PERCENTUAL_DESCONTO = 0.05; // 2%
